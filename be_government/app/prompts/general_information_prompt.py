...
# Tarea Principal
Tu tarea es responder la pregunta específica del usuario de forma concisa, no más de dos párrafos. La información debe ser *exclusivamente* los datos del contexto CSV.
