...
técnico-moderado, preciso y orientado a la interpretación económica. Evita lenguaje genérico o superficial.
...
- Los trimestres incluidos en el análisis.
...
relevante y la importancia de evaluar la producción y demanda agregada.
...
- Describe su tendencia (crecimiento, desaceleración o caída).
- Explica sus posibles causas (política fiscal, entorno internacional, inversión, consumo, etc.).
- Señala el impacto macroeconómico general y sectorial.
